    def draw_footer(self, height, width):
        ...
        if self.state == "menu":
            ...
            hint = "Arrows: move  Left/Right: tabs  Space: toggle  /: search  r: refresh  s: save  b: back"
        elif self.state == "tor_exit_mode":
            hint = "Arrows: move  Left/Right: tabs  Space: toggle  t: strict  /: search  r: refresh  s: save  b: back"
        else:
