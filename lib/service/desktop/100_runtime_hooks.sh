...
chroot_service_desktop_restart() {
  ...
  chroot_log_run_internal_command service service.start "$distro" "$distro" service start "$CHROOT_SERVICE_DESKTOP_SERVICE_NAME" -- chroot_service_desktop_start "$distro"
}
