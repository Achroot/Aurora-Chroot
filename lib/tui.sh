...
chroot_cmd_tui() {
  ...
  CHROOT_HELP_TEXT="$(chroot_help_full_text)" \
  CHROOT_HELP_RENDERED_TEXT="$(chroot_help_render_full_text)" \
  CHROOT_HELP_RAW_TEXT="$(chroot_help_raw_text)" \
  CHROOT_HELP_RAW_RENDERED_TEXT="$(chroot_help_render_raw_text)" \
